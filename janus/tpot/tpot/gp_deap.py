    ...
    if use_dask:
        ...
        try:
            with warnings.catch_warnings():
                ...
                # TODO: this is where we should modify
                # and record time for exec
            ...
            CV_score = scores_arr[:, 0]
            CV_fit_time = scores_arr[:, 1]
            return np.nanmean(CV_score), np.nanmean(CV_fit_time)
